...
public abstract class AbstractSerialStateHolder implements Externalizable {
  ...
  protected final Object readResolve() throws ObjectStreamException {
    ...
    return this.createDeserializationProxy(userBean,  objectFactory, arrayTypes, arrayValues);
  }

  protected abstract Object createDeserializationProxy(Object target, ObjectFactory objectFactory, List<Class<?>> constructorArgTypes, List<Object> constructorArgs);
