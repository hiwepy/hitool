...
public abstract class AbstractEnhancedDeserializationProxy {
  ...
  protected AbstractEnhancedDeserializationProxy(Class<?> type, ObjectFactory objectFactory, List<Class<?>> constructorArgTypes, List<Object> constructorArgs) {
    this.type = type;
  ...
  public final Object invoke(Object enhanced, Method method, Object[] args) throws Throwable {
    ...
    try {
      if (WRITE_REPLACE_METHOD.equals(methodName)) {
        ...
        return this.newSerialStateHolder(original, objectFactory, constructorArgTypes, constructorArgs);
      } else {
